...
function BrandCreate() {
  ...
  const onSubmit = async (obj) => {
    ...
    try {
      const response = await axios.post(`http://localhost:8888/api/v1/admin/craeteBrand`, objPush);
      toast.success("Create brand secesss !! ")
      natigate("/admin/brand")
    } catch (err) {
      alert(err);
    }
  }
          ...
          <div className="page-title">
            <div className="row">
              <div className="col-12 col-md-6 order-md-1 order-last">
                ...
                <h3>Create Brand</h3>
                <p className="text-subtitle text-muted"> Infomation about Brand </p>
              </div>
